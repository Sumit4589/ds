...
import com.sam.ds.graph.WeightedAdjMatrixGraph.Edge;
...
class WeightedAdjMatrixGraph {
  ...
  public int[] primsMst(int start) {
    int[] distKey = new int[vertCount];
    Arrays.fill(distKey, INF);
    distKey[start] = 0;
    int[] parent = new int[vertCount];
    Arrays.fill(parent, -1);
 ...
 * 
 * @Override public int compare(Edge e1, Edge e2) { return e1.weight - e2.weight; } });
 */
