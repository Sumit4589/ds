package com.sam.ds.graph;

import java.util.Arrays;
import java.util.Scanner;

class WeightedAdjMatrixGraphPrims {
  public static final int INF = 999; // Integer.MAX_VALUE;
  private int[][] mat;
  private int vertCount, edgeCount;

  public WeightedAdjMatrixGraphPrims(int vCount) {
    edgeCount = 0;
    vertCount = vCount;
  ...
  public void dijkstraShortestpath(int src, int dest) {
    ...
    for (int v = 0; v < vertCount; v++) {
      if (mat[src][v] != INF) {
        dist[v] = Math.min(dist[src] + mat[src][v], dist[v]);
      }
    }
  }
}
...
public class PrimsMain {
  public static void main(String[] args) {
    ...
    WeightedAdjMatrixGraphPrims g = new WeightedAdjMatrixGraphPrims(vCount);
    g.accept(sc);
    g.display();
...
/*
 * 9 14 7 6 1 8 2 2 6 5 2 0 1 4 2 5 4 8 6 6 2 3 7 7 8 7 0 7 8 1 2 8 3 4 9 5 4 10 1 7 11 3 5 14
 */
