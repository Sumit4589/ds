...
class BinSearchTree {
  ...
  /*
   * public Node binSearch(Node trav, int key) { if(trav == null) return null; if(key == trav.data)
   * return trav; if(key < trav.data) return binSearch(trav.left, key); else // if(key >= trav.data)
   * return binSearch(trav.right, key); } public Node binSearch(int key) { return binSearch(root,
   * key); }
   */
...
public class BSTMain {
  public static void main(String[] args) {
    ...
    BinSearchTree.Node found[] = t.binSearchWithParent(80);
