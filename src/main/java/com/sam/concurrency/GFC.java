...
class A {
  ...
  public synchronized void last() {
    ...
    System.out.println(Thread.currentThread() + " Inside A, last() method");
  }
  ...
  public synchronized void d1(B b) {
    System.out.println(
        Thread.currentThread() + " start execution of d1() method");
    ...
    // Display statement
    System.out.println(
        Thread.currentThread() + " trying to call B's last() method");
...
class B {
  ...
  public synchronized void last() {
    ...
    System.out.println(Thread.currentThread() + " Inside B, last() method");
  }
  ...
  public synchronized void d2(A a) {
    ...
    System.out.println(
        Thread.currentThread() + " start execution of d2() method");
    ...
    // Display message only
    System.out.println(
        Thread.currentThread() + " trying to call A's last method");
